...
def summarize_results(file_path):
    ...
    try:
        ...
        # 'balanced_accuracy', and 'macro_f1_score'.
    ...
    metrics = ['balanced_accuracy', 'macro_f1_score']
    ...
    # The aggregation creates multi-level column names (e.g., ('balanced_accuracy', 'mean')).
    ...
    output_filename = '../../results/downstream/task_05_imputing_test_set/summary_statistics.csv'
...
if __name__ == '__main__':
    ...
    input_file = '../../results/downstream/task_05_imputing_test_set/results_10_runs.csv'
